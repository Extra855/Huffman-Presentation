...
COLOR_MAP = {
    ...
    "GPS_RED": "#ED1C24",
    "CROSS_RED": "#DD3333",
    "CHECKMARK_GREEN": "#41AD49",
    "DARK_GREEN": "#197419",
    "COBALT_BLUE": "#0047ab",
    "KELLY_GREEN": "#74B72E",
    "SEAFOAM_GREEN": "#01DAC6",
    "PERIWINKLE_BLUE": "#B3B3FF",
    "LIME_GREEN": "#32CD32",
    # "YELLOW": "#FFFF00",
    # "BLUE": "#0000FF",
    # "RED": "#FF0000",
    ...
    # "STORM_GRAY": "#ffffff",
    # "WHEAT": "#ffffff",
    # "PENCIL_SHADE_TOP": "#ffffff",
    # "CHECKMARK_GREEN": "#ffffff",
    # "CROSS_RED": "#ffffff",
    # "MONOKAI_PINK": "#ffffff",
    # "MONOKAI_GREEN": "#ffffff",
    # "MONOKAI_BLUE": "#ffffff",
    # "MONOKAI_ORANGE": "#ffffff",
    # "MONOKAI_PURPLE": "#ffffff",
    # "MONOKAI_ORANGE": "#ffffff",
